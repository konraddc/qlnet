...
//    property var weights_vector: []
    ...
    property bool isReady: o0_1.value && o0_0.value
...
//    }
    ...
    Item {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: parent.value = net.resolve([root.input_vector[0]], root.param)
        }
    }
    ...
    Item {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: parent.value = net.resolve([root.input_vector[1]], root.param)
        }
    }
}
